...
// Left navigation tree (B1) with collapsible accordion groups — like the
// original DFD (Docusaurus) docs sidebar. Groups start expanded; the header
// toggles each group open/closed. NavLink resolves the active page itself.
